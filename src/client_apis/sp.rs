...
impl AmazonAdClient {
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::campaigns::Campaign>>, crate::apis::Error<serde_json::Value>>
    {
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::campaigns::CampaignResponse>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::ad_groups::AdGroup>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::ad_groups::AdGroupResponse>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::keywords::Keyword>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::keywords::KeywordResponse>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::negative_keywords::NegativeKeyword>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::negative_keywords::NegativeKeywordResponse>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::product_ads::ProductAd>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::product_ads::ProductAdResponse>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::targeting::TargetingClause>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::negative_targeting::NegativeTargetingClause>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    pub async fn sp_list_campaign_negative_keywords(
        &self,
        request: Option<crate::models::sp::campaign_negative_keywords::ListCampaignNegativeKeywordsRequest>,
    ) -> Result<ApiResponse<Vec<crate::models::sp::campaign_negative_keywords::CampaignNegativeKeyword>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_keywords::list_campaign_negative_keywords(&config, request).await
    }
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::campaign_negative_keywords::CampaignNegativeKeywordResponse>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_keywords::create_campaign_negative_keywords(&config, body).await
    }
    ...
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_keywords::update_campaign_negative_keywords(&config, body).await
    }
    ...
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_keywords::delete_campaign_negative_keywords(&config, request).await
    }
    ...
    pub async fn sp_list_campaign_negative_targets(
        &self,
        request: Option<crate::models::sp::campaign_negative_targets::ListCampaignNegativeTargetsRequest>,
    ) -> Result<ApiResponse<Vec<crate::models::sp::campaign_negative_targets::CampaignNegativeTargetingClause>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_targets::list_campaign_negative_targets(&config, request).await
    }
    ...
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_targets::create_campaign_negative_targets(&config, body).await
    }
    ...
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_targets::update_campaign_negative_targets(&config, body).await
    }
    ...
    {
        let config = self.create_configuration().await?;
        crate::apis::sp::campaign_negative_targets::delete_campaign_negative_targets(&config, request).await
    }
    ...
    ) -> Result<ApiResponse<crate::models::sp::reports::ReportResponse>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<crate::models::sp::snapshots::SnapshotResponse>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    pub async fn sp_get_snapshot_status(
        &self,
        snapshot_id: &str,
    ) -> Result<ApiResponse<crate::models::sp::snapshots::SnapshotStatusResponse>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    pub async fn sp_list_budget_rules(
        &self,
    ) -> Result<ApiResponse<Vec<crate::models::sp::budget_rules::BudgetRule>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    pub async fn sp_get_budget_rule(
        &self,
        rule_id: &str,
    ) -> Result<ApiResponse<crate::models::sp::budget_rules::BudgetRule>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::bids::BidRecommendation>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
    ...
    ) -> Result<ApiResponse<Vec<crate::models::sp::recommendations::SuggestedKeyword>>, crate::apis::Error<serde_json::Value>>
    {
        let config = self.create_configuration().await?;
