...
#[serde(rename_all = "camelCase")]
#[builder(setter(into, strip_option), default)]
pub struct ListAdGroupsRequest {
...
#[serde(rename_all = "camelCase")]
#[builder(setter(into, strip_option), default)]
pub struct DeleteAdGroupsRequest {
    pub ad_group_id_filter: super::campaigns::ObjectIdFilter,
}
