...
pub async fn list_portfolios(
    ...
    let req = configuration.client.request(reqwest::Method::GET, format!("{}/v2/portfolios", configuration.base_path))
...
pub async fn create_portfolios(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/v2/portfolios", configuration.base_path))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
        .build()?;
...
pub async fn update_portfolios(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/v2/portfolios", configuration.base_path))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
        .build()?;
...
pub async fn delete_portfolio(
    ...
    let req = configuration.client.request(reqwest::Method::DELETE, format!("{}/v2/portfolios/{}", configuration.base_path, portfolio_id))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .build()?;
