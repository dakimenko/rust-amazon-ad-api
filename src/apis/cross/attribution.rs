...
> {
    unimplemented!("list_advertisers stub")
}
...
pub async fn list_publishers(
    ...
    crate::apis::Error<serde_json::Value>,
> {
    unimplemented!("list_publishers stub")
}
...
pub async fn list_tags(
    ...
    crate::apis::Error<serde_json::Value>,
> {
    unimplemented!("list_tags stub")
}

pub async fn create_attribution_report(
    _configuration: &crate::apis::configuration::Configuration,
) -> Result<
    crate::models::common::ApiResponse<serde_json::Value>,
    crate::apis::Error<serde_json::Value>,
> {
    unimplemented!("create_attribution_report stub")
}
