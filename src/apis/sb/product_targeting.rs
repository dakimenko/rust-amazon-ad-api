...
pub async fn list_targets(
    ...
    let mut req = client
        .request(reqwest::Method::GET, format!("{}/sb/targets", configuration.base_path))
...
pub async fn create_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sb/targets", configuration.base_path))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
        .build()?;
...
pub async fn update_targets(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sb/targets", configuration.base_path))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
        .build()?;
...
pub async fn delete_target(
    ...
    let req = configuration.client.request(reqwest::Method::DELETE, format!("{}/sb/targets/{}", configuration.base_path, target_id))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .build()?;
    crate::apis::helpers::execute_request(configuration, req).await
