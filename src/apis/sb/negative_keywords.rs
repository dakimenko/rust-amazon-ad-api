...
pub async fn list_negative_keywords(
    ...
    let mut req = client
        .request(reqwest::Method::GET, format!("{}/sb/negativeKeywords", configuration.base_path))
...
pub async fn create_negative_keywords(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sb/negativeKeywords", configuration.base_path))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
        .build()?;
...
pub async fn update_negative_keywords(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sb/negativeKeywords", configuration.base_path))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
        .build()?;
...
pub async fn delete_negative_keyword(
    ...
    let req = configuration.client.request(reqwest::Method::DELETE, format!("{}/sb/negativeKeywords/{}", configuration.base_path, keyword_id))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .build()?;
    crate::apis::helpers::execute_request(configuration, req).await
