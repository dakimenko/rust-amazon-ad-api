...
pub async fn list_ad_groups(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sd/adGroups/list", configuration.base_path))
...
pub async fn create_ad_groups(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sd/adGroups", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn update_ad_groups(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sd/adGroups", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn delete_ad_groups(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sd/adGroups/delete", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&request)
        .build()?;
