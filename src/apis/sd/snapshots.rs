...
pub async fn create_snapshot(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sd/snapshots", configuration.base_path))
...
pub async fn get_snapshot_status(
    ...
    let req = configuration.client.request(reqwest::Method::GET, format!("{}/sd/snapshots/{}", configuration.base_path, snapshot_id))
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .build()?;
    crate::apis::helpers::execute_request(configuration, req).await
