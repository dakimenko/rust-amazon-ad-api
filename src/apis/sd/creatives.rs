...
pub async fn list_creatives(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sd/creatives/list", configuration.base_path))
...
pub async fn create_creatives(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sd/creatives", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn update_creatives(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sd/creatives", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
