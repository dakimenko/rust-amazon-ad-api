...
pub async fn check_optimization_eligibility(
    ...
    let req = configuration
        ...
        .request(
            reqwest::Method::POST,
            format!("{}/sp/rules/eligibility", configuration.base_path),
        )
...
pub async fn create_optimization_rule(
    ...
    let req = configuration
        ...
        .request(
            reqwest::Method::POST,
            format!("{}/sp/rules/campaignOptimization", configuration.base_path),
        )
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
        .json(&body)
    ...
    let req = configuration
        ...
        .request(
            ...
            format!(
                ...
                configuration.base_path, rule_id
            ),
        )
        .header("Accept", "application/json")
        .header("Content-Type", "application/json")
...
pub async fn get_consolidated_recommendations(
    ...
    let req = configuration
        ...
        .request(
            reqwest::Method::GET,
            format!(
                "{}/sp/campaigns/recommendations/consolidated",
