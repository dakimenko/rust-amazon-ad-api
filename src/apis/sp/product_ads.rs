...
pub async fn list_product_ads(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/productAds/list", configuration.base_path))
...
pub async fn create_product_ads(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/productAds", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn update_product_ads(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sp/productAds", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn delete_product_ads(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/productAds/delete", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&request)
        .build()?;
