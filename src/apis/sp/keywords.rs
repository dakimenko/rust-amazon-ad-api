...
pub async fn list_keywords(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/keywords/list", configuration.base_path))
...
pub async fn create_keywords(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/keywords", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn update_keywords(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sp/keywords", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn delete_keywords(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/keywords/delete", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&request)
        .build()?;
