...
pub async fn list_negative_keywords(
    ...
    let req = configuration
        ...
        .request(
            reqwest::Method::POST,
            format!("{}/sp/negativeKeywords/list", configuration.base_path),
        )
...
pub async fn create_negative_keywords(
    ...
    let req = configuration
        ...
        .request(
            reqwest::Method::POST,
            format!("{}/sp/negativeKeywords", configuration.base_path),
        )
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
...
pub async fn delete_negative_keywords(
    ...
    let req = configuration
        ...
        .request(
            reqwest::Method::POST,
            format!("{}/sp/negativeKeywords/delete", configuration.base_path),
        )
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&request)
