...
pub async fn list_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/targets/list", configuration.base_path))
...
pub async fn create_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/targets", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn update_targets(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sp/targets", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn delete_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/targets/delete", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&request)
        .build()?;
