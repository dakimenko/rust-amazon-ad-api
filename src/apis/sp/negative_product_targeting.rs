...
pub async fn list_negative_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/negativeTargets/list", configuration.base_path))
...
pub async fn create_negative_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/negativeTargets", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn update_negative_targets(
    ...
    let req = configuration.client.request(reqwest::Method::PUT, format!("{}/sp/negativeTargets", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&body)
        .build()?;
...
pub async fn delete_negative_targets(
    ...
    let req = configuration.client.request(reqwest::Method::POST, format!("{}/sp/negativeTargets/delete", configuration.base_path))
        .header("Accept", VERSION_HEADER)
        .header("Content-Type", VERSION_HEADER)
        .json(&request)
        .build()?;
